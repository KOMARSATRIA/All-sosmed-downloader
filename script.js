...
function downloadFile() {
    ...
    // Mengalihkan tautan video ke web unduhan global yang otomatis bypass token kedaluwarsa
    const bypassUrl = "https://render-hk.allinone-downloader.xyz/download?url=" + encodeURIComponent(videoUrl);
